...
const Unit1 = () => {
  ...
  return (
    <div>
      ...
      <div>
        <img className=" rounded-2xl shadow-md" src={laptop} alt="alt" />
      </div>

      <div className="flex items-center mb-3 mt-3 relative">
        <svg className="search absolute ml-2" height="1rem" width="1rem" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
